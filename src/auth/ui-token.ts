...
// The scope segment of a token, without verifying it. For policy checks
// (e.g. "reject submit: tokens here") before the HMAC verify.
export function scopeOf(token: string): string {
